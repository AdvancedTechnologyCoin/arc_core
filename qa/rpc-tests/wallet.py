...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 ARC, node2 has none. 
#   d) node0 sends 21 ARC to node2, in two transactions (11 ARC, then 10 ARC).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # node0 should end up with 1000 ARC in block rewards plus fees, but

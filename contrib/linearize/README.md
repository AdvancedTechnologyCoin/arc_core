# Linearize
Construct a linear, no-fork, best version of the Arc blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install arc_hash

https://github.com/AdvancedTechnologyCoin/arc_core_hash
...
JSON-RPC server. Running `arcd` or `arc-qt -server` will be sufficient.
...
* `input`: arcd blocks/ directory containing blkNNNNN.dat

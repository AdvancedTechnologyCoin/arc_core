...
UniValue getblocktemplate(const UniValue& params, bool fHelp)
{
    ...
    if(pblock->txoutGoldminenode != CTxOut()) {
        ...
        goldminenodeObj.push_back(Pair("script", HexStr(pblock->txoutGoldminenode.scriptPubKey.begin(), pblock->txoutGoldminenode.scriptPubKey.end())));
        goldminenodeObj.push_back(Pair("amount", pblock->txoutGoldminenode.nValue));
    }
    result.push_back(Pair("goldminenode", goldminenodeObj));
    result.push_back(Pair("goldminenode_payments_started", pindexPrev->nHeight + 1 > 750) );

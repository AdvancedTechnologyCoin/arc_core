...
bool CSporkManager::IsSporkActive(int nSporkID)
{
	...
	if( r < 0 ){
        switch (nSporkID) {
			...
			case SPORK_21_GOLDMINENODE_ORDER_ENABLE:   r = SPORK_21_GOLDMINENODE_ORDER_ENABLE_DEFAULT; break;
			case SPORK_22_GOLDMINENODE_UPDATE_PROTO:   r = SPORK_22_GOLDMINENODE_UPDATE_PROTO_DEFAULT; break;
			case SPORK_23_GOLDMINENODE_UPDATE_PROTO2:   r = SPORK_23_GOLDMINENODE_UPDATE_PROTO2_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
		...
		case SPORK_21_GOLDMINENODE_ORDER_ENABLE:   return SPORK_21_GOLDMINENODE_ORDER_ENABLE_DEFAULT;		
		case SPORK_22_GOLDMINENODE_UPDATE_PROTO:   return SPORK_22_GOLDMINENODE_UPDATE_PROTO_DEFAULT;	
		case SPORK_23_GOLDMINENODE_UPDATE_PROTO2:   return SPORK_23_GOLDMINENODE_UPDATE_PROTO2_DEFAULT; break;	

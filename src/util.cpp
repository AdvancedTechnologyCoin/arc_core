...
const char * const BITCOIN_CONF_FILENAME = "arc.conf";
const char * const BITCOIN_PID_FILENAME = "arcd.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/arc";
#else
    // Unix
    return pathRet / ".arc";
#endif
...
void ReadConfigFile(const std::string& confPath)
{
    ...
    if (!streamConfig.good()){
        // Create empty arc.conf if it does not excist
...

    {
        ...
        {
            // Don't overwrite existing settings so command line settings override arc.conf

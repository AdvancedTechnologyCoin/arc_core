...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Arctic
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Arctic
    // Mac: ~/Library/Application Support/Arctic
    // Unix: ~/.arcticcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Arctic";
#else
    fs::path pathRet;
    ...
    return pathRet / "Arctic";
#else
    // Unix
    return pathRet / ".arcticcoin";
#endif
#endif
}
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "arcticcoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "arcticcoind.pid"));

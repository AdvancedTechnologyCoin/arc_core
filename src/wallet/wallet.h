...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED,
    ONLY_NONDENOMINATED,
    ONLY_1000, // find goldminenode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 1000ARC output and keys which can be used for the Goldminenode
    bool GetGoldminenodeOutpointAndKeys(COutPoint& outpointRet, CPubKey& pubKeyRet, CKey& keyRet, const std::string& strTxHash = "", const std::string& strOutputIndex = "");

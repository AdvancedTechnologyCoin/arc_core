...
enum AvailableCoinsType
{
    ...
    ONLY_1000 = 5, // find goldminenode outputs including locked ones (use with caution)
...
public:
    ...
    bool GetGoldminenodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");

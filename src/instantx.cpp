...
//step 2.) Top INSTANTX_SIGNATURES_TOTAL goldmines, open connect to top 1 goldmine.
//         Send "txvote", CTransaction, Signature, Approve
//step 3.) Top 1 goldmine, waits for INSTANTX_SIGNATURES_REQUIRED messages. Upon success, sends "txlock'
...
int64_t CreateNewLock(CTransaction tx)
{
    ...
    /*
        ...
        This prevents attackers from using transaction mallibility to predict which goldmines
        they'll use.
    */

...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    FillBlockPayments(coinbaseTx, nHeight, blockReward, blockEvolution,pblock->txoutGoldminenode, pblock->voutSuperblock);
    // LogPrintf("CreateNewBlock -- nBlockHeight %d blockReward %lld txoutGoldminenode %s coinbaseTx %s",
    //             nHeight, blockReward, pblock->txoutGoldminenode.ToString(), coinbaseTx.ToString());

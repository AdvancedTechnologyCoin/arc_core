...
public:
    ...
    bool CheckSignature(const CPubKey& pubKeyGoldminenode);
    ...
    std::string ToString()
    {
        return strprintf("nDenom=%d, nTime=%lld, fReady=%s, fTried=%s, goldminenode=%s",
...
private:
    ...
    /// As a client, submit part of a future mixing transaction to a Goldminenode to start the process
    ...
    /// Get Goldminenode updates about the progress of mixing
...
public:
    CGoldminenode* pSubmittedToGoldminenode;

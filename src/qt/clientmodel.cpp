...
QString ClientModel::getGoldminenodeCountString() const
{
...
{
    QString newGoldminenodeCountString = getGoldminenodeCountString();

    if (cachedGoldminenodeCountString != newGoldminenodeCountString)
    {
        cachedGoldminenodeCountString = newGoldminenodeCountString;

        Q_EMIT strGoldminenodesChanged(cachedGoldminenodeCountString);
    }
}

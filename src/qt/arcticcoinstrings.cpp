...
#define UNUSED
#endif
static const char UNUSED *arcticcoin_strings[] = {
...
QT_TRANSLATE_NOOP("arcticcoin-core", ""
"To use arcticcoind, or the -server option to arcticcoin-qt, you must set an rpcpassword "
...
"your clock is wrong Arctic Core will not work properly."),
QT_TRANSLATE_NOOP("arcticcoin-core", ""
...
QT_TRANSLATE_NOOP("arcticcoin-core", "(default: 1)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "(must be 7209 for mainnet)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "<category> can be:\n"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Accept command line and JSON-RPC commands"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Accept connections from outside (default: 1 if no -proxy or -connect)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Accept public REST requests (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Acceptable ciphers (default: %s)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Add a node to connect to and attempt to keep the connection open"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Allow DNS lookups for -addnode, -seednode and -connect"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Already have that input."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Always query for peer addresses via DNS lookup (default: %u)"),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "Cannot resolve -externalip address: '%s'"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Cannot resolve -whitebind address: '%s'"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Connect only to the specified node(s)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Connect through SOCKS5 proxy"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Connect to KeePassHttp on port <port> (default: %u)"),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "Error loading wallet.dat"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Error loading wallet.dat: Wallet corrupted"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Error loading wallet.dat: Wallet requires newer version of Arctic Core"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Error opening block database"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Error reading from database, shutting down."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Error recovering public key."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Error"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Error: A fatal internal error occured, see debug.log for details"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Error: Can't select current denominated inputs"),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "Finalizing transaction."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Force safe mode (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Generate coins (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "If <category> is not supplied, output all debugging information."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Importing..."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Imports blocks from external blk000??.dat file"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Incompatible version."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "Invalid amount for -maxtxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Invalid amount for -minrelaytxfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "Options:"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "RPC server options:"),
QT_TRANSLATE_NOOP("arcticcoin-core", "RPC support for HTTP persistent connections (default: %d)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Randomly drop 1 of every <n> network messages"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Randomly fuzz 1 of every <n> network messages"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Rebuild block chain index from current blk000??.dat files"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Rescan the block chain for missing wallet transactions"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Rescanning..."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Run a thread to flush wallet periodically (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Server private key (default: %s)"),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "Shrink debug.log file on client startup (default: 1 when no -debug)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Signing failed."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Signing timed out."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Signing transaction failed"),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "This is not a Goldmine."),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Transaction too large"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Transmitting final transaction."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Unknown network specified in -onlynet: '%s'"),
...
QT_TRANSLATE_NOOP("arcticcoin-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Wallet needed to be rewritten: restart Arctic Core to complete"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Wallet options:"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Wallet window title"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Warning"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Warning: This version is obsolete, upgrade required!"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Warning: Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Warning: Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Will retry..."),
QT_TRANSLATE_NOOP("arcticcoin-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("arcticcoin-core", "Your transaction was accepted into the pool!"),
QT_TRANSLATE_NOOP("arcticcoin-core", "Zapping all transactions from wallet..."),
QT_TRANSLATE_NOOP("arcticcoin-core", "on startup"),
QT_TRANSLATE_NOOP("arcticcoin-core", "wallet.dat corrupt, salvage failed"),
};

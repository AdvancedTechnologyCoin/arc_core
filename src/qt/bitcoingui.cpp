...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Arctic Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Arctic"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Arctic Core help message to get a list with possible Arctic command-line options"));

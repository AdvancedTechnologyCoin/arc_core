...
void BitcoinGUI::createActions()
{
    ...
    openMNConfEditorAction = new QAction(QIcon(":/icons/" + theme + "/edit"), tr("Open &Goldmine Configuration File"), this);
    openMNConfEditorAction->setStatusTip(tr("Open Goldmine configuration file"));    

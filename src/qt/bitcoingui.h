...
private Q_SLOTS:
    ...
    /** Switch to goldminenode page */
    void gotoGoldminenodePage();
    ...
    /** Open external (default) editor with arcticcoin.conf */
    void showConfEditor();
    /** Open external (default) editor with goldminenode.conf */

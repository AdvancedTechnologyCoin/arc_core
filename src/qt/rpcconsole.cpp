...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        setGoldminenodeCount(model->getGoldminenodeCountString());
        connect(model, SIGNAL(strGoldminenodesChanged(QString)), this, SLOT(setGoldminenodeCount(QString)));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Arctic Core RPC console.") + "<br>" +
...
void RPCConsole::setGoldminenodeCount(const QString &strGoldminenodes)
{
    ui->goldminenodeCount->setText(strGoldminenodes);
}

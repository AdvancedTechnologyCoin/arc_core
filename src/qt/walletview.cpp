    ...
    platformStyle(_platformStyle)
{
    ...
    if (!fLiteMode && settings.value("fShowGoldminenodesTab").toBool()) {
        goldminenodeListPage = new GoldminenodeList(platformStyle);
        addWidget(goldminenodeListPage);
    }
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    QSettings settings;
    if (!fLiteMode && settings.value("fShowGoldminenodesTab").toBool()) {
        goldminenodeListPage->setClientModel(_clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    QSettings settings;
    if (!fLiteMode && settings.value("fShowGoldminenodesTab").toBool()) {
        goldminenodeListPage->setWalletModel(_walletModel);
    }
...
void WalletView::gotoGoldminenodePage()
{
    QSettings settings;
    if (!fLiteMode && settings.value("fShowGoldminenodesTab").toBool()) {
        setCurrentWidget(goldminenodeListPage);
    }
}

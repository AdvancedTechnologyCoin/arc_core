...
private:
    ...
    std::vector<COutPoint> vecGoldminenodesUsed;
    ...
    goldminenode_info_t infoMixingGoldminenode;
...
public:
    ...
    bool GetMixingGoldminenodeInfo(goldminenode_info_t& mnInfoRet);
    bool IsMixingGoldminenode(const CNode* pnode);

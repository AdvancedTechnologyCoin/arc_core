...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Arctic Core arcticcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  arcticcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded arcticcoin transaction") + "\n" +
              "  arcticcoin-tx [options] -create [commands]   " + _("Create hex-encoded arcticcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded arcticcoin transaction

/* src/config/arc-config.h.  Generated from arc-config.h.in by configure.  */
/* src/config/arc-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Arc Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Arc Core"
...
#define PACKAGE_BUGREPORT "https://github.com/arcpay/arc/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Arc Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Arc Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "arccore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://arc.org/"

...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr3 = ResolveService("250.3.2.2", 7209);
    CService addr4 = ResolveService("250.3.3.3", 7209);
    ...
    BOOST_CHECK(addrman.Select().ToString() == "250.3.2.2:7209");
    BOOST_CHECK(addrman.Select().ToString() == "250.3.3.3:7209");
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.2.1", 7209), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.251.2.2", 7209), NODE_NONE);

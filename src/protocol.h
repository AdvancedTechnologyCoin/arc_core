...
extern const char *GOLDMINENODEPAYMENTVOTE;
extern const char *GOLDMINENODEPAYMENTSYNC;
...
enum GetDataMsg {
    ...
    MSG_TXLOCK_VOTE = 5,
    MSG_SPORK = 6,
    MSG_GOLDMINENODE_PAYMENT_VOTE = 7,
    MSG_GOLDMINENODE_PAYMENT_BLOCK = 8, // reusing, was MSG_GOLDMINENODE_SCANNING_ERROR previousely, was NOT used in 12.0
    ...
    MSG_GOLDMINENODE_QUORUM = 13, // not implemented
    MSG_GOLDMINENODE_ANNOUNCE = 14,
    MSG_GOLDMINENODE_PING = 15,
    MSG_DSTX = 16,
    MSG_GOLDMINENODE_VERIFY = 19,

...
private:
    ...
    object_time_m_t mapGoldminenodeOrphanObjects;
    ...
    txout_m_t mapLastGoldminenodeObject;
...
public:
    ...
    void Clear()
    {
        ...
        mapLastGoldminenodeObject.clear();
    }
    ...
    bool GoldminenodeRateCheck(const CGovernanceObject& govobj, bool fUpdateLast = false);

    bool GoldminenodeRateCheck(const CGovernanceObject& govobj, bool fUpdateLast, bool fForce, bool& fRateCheckBypassed);
    ...
    void CheckGoldminenodeOrphanVotes();

    void CheckGoldminenodeOrphanObjects();
...
private:
    ...
    int GetGoldminenodeIndex(const CTxIn& goldminenodeVin);

...
private:
    ...
    /// Goldminenode info for signed objects
    ...
    // VARIOUS FLAGS FOR OBJECT / SET VIA GOLDMINENODE VOTING
...
public:
    ...
    const CTxIn& GetGoldminenodeVin() const {
        return vinGoldminenode;
    }
    ...
    void SetGoldminenodeInfo(const CTxIn& vin);
    bool Sign(CKey& keyGoldminenode, CPubKey& pubKeyGoldminenode);
    bool CheckSignature(CPubKey& pubKeyGoldminenode);

...
/** Maximum number if outgoing goldminenodes */
static const int MAX_OUTBOUND_GOLDMINENODE_CONNECTIONS = 20;
/** -listen default */
...
public:
    ...
    bool OpenNetworkConnection(const CAddress& addrConnect, bool fCountFailure, CSemaphoreGrant *grantOutbound = NULL, const char *strDest = NULL, bool fOneShot = false, bool fFeeler = false, bool fAddnode = false, bool fConnectToGoldminenode = false);
    bool OpenGoldminenodeConnection(const CAddress& addrConnect);
    ...
    bool IsGoldminenodeOrDisconnectRequested(const CService& addr);
    ...
    bool AddPendingGoldminenode(const CService& addr);
...
private:
    ...
    void ThreadOpenGoldminenodeConnections();
    ...
    std::vector<CService> vPendingGoldminenodes;
    CCriticalSection cs_vPendingGoldminenodes;
    ...
    CSemaphore *semGoldminenodeOutbound;
    int nMaxConnections;
    int nMaxOutbound;
    int nMaxAddnode;
    int nMaxFeeler;
    ...
    std::thread threadOpenGoldminenodeConnections;
...
public:
    ...
    bool fSentAddr;
    // If 'true' this node will be disconnected on CGoldminenodeMan::ProcessGoldminenodeConnections()
    bool fGoldminenode;
    CSemaphoreGrant grantOutbound;
    CSemaphoreGrant grantGoldminenodeOutbound;

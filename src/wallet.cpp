...
int CWallet::GetRealInputDarksendRounds(CTxIn in, int rounds) const
{
    ...
    if(wtx != NULL)
    {
        ...
        {
            LogPrint("spysend", "GetInputDarksendRounds INSERTING %s\n", hash.ToString());
        ...
        if(nout >= wtx->vout.size())
        {
            ...
            LogPrint("spysend", "GetInputDarksendRounds UPDATED   %s %3d %3d\n", hash.ToString(), nout, -4);
            return -4;
        }
...
string CWallet::PrepareDarksendDenominate(int minRounds, int maxRounds)
{
    ...
    */
    ...
    LogPrintf("PrepareDarksendDenominate - preparing spysend denominate . Got: %d \n", nValueIn);

...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ArcticNetwork") type = ArcticNetwork;
    if(strType == "ArcticNetworkVariable") type = ArcticNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ArcticNetwork) s = "ArcticNetwork";
    if(type == ArcticNetworkVariable) s = "ArcticNetworkVariable";

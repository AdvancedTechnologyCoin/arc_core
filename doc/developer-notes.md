...
However, in open source software such as Arctic Core, where everyone uses
...
pay attention to for reviewers of Arctic Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Arctic Core uses tinyformat, which is type safe. Leave them out to avoid confusion

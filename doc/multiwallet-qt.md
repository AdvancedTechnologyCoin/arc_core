...
Only requiring some minor changes is arc.cpp.
...
Changes to arc.cpp
----------------------
arc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

...
Only requiring some minor changes is arcticcoin.cpp.
...
Changes to arcticcoin.cpp
----------------------
arcticcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

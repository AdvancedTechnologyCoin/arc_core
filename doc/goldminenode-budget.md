...
Format: ```mngovernance prepare proposal-name url payment-count block-start arc-address monthly-payment-arc```
...
Format: ```mngovernance submit proposal-name url payment-count block-start arc-address monthly-payment-arc fee-tx```
...
If everything looks correct, you can ask for votes from other goldminenodes. To vote on a proposal, load a wallet with _goldminenode.conf_ file. You do not need to access your cold wallet to vote for proposals.
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single goldminenode (using arc.conf setup)

...
Format: ```mngovernance prepare proposal-name url payment-count block-start arcticcoin-address monthly-payment-arcticcoin```
...
Format: ```mngovernance submit proposal-name url payment-count block-start arcticcoin-address monthly-payment-arcticcoin fee-tx```

...
- `bitcoinconsensus_SCRIPT_FLAGS_VERIFY_P2SH` - Evaluate P2SH ([BIP16](https://github.com/bitcoin/bips/blob/goldmine/bip-0016.mediawiki)) subscripts
- `bitcoinconsensus_SCRIPT_FLAGS_VERIFY_DERSIG` - Enforce strict DER ([BIP66](https://github.com/bitcoin/bips/blob/goldmine/bip-0066.mediawiki)) compliance
...
- [NBitcoin](https://github.com/NicolasDorier/NBitcoin/blob/goldmine/NBitcoin/Script.cs#L814) (.NET Bindings)

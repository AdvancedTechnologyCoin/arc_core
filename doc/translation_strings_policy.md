...
This document provides guidelines for internationalization of the Arc Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `arc_en.ts` remains unchanged.
